...
./gradlew --stop
KUIKLY_AGP_VERSION="7.1.3" KUIKLY_KOTLIN_VERSION="1.8.21" ./gradlew -c settings.1.8.21.gradle.kts :core:publishToMavenLocal --stacktrace
KUIKLY_AGP_VERSION="7.1.3" KUIKLY_KOTLIN_VERSION="1.8.21" ./gradlew -c settings.1.8.21.gradle.kts :core-render-android:publishToMavenLocal --stacktrace
KUIKLY_AGP_VERSION="7.1.3" KUIKLY_KOTLIN_VERSION="1.8.21" ./gradlew -c settings.1.8.21.gradle.kts :core-annotations:publishToMavenLocal --stacktrace
KUIKLY_AGP_VERSION="7.1.3" KUIKLY_KOTLIN_VERSION="1.8.21" ./gradlew -c settings.1.8.21.gradle.kts :core-ksp:publishToMavenLocal --stacktrace
